 ...
 */
final class Version20220520083618 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories_products (products_id INT NOT NULL, categories_id INT NOT NULL, INDEX IDX_6544F3636C8A81A9 (products_id), INDEX IDX_6544F363A21214B7 (categories_id), PRIMARY KEY(products_id, categories_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
